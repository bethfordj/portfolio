...
Insert Into business (business_id, name, slogan, image, rating) Values (default, 'testBusiness', 'The Best Test Business To Best Test!', 'testImageName', '4.73');
Insert Into type (type_id, specific_type, general_type) Values (default, 'testSpecType', 'testGenType');
