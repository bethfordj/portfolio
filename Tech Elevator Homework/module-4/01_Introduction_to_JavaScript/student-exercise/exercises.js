...
function seeColor(string) {
	...
	else if (string.substr(0,4) == 'blue') {
		return 'blue';
	}
	else {
		return '';
...
function cigarParty(numberOfCigars, weekend){
	if (numberOfCigars < 61 && numberOfCigars > 39 && weekend == false) {
		return true;
	}
	else if (numberOfCigars > 39 && weekend == true) {
		return true;
	}
	else {
		return false;
...
function createObject(b = 'Beth', f = 'Ford', a = 32) {
	const person = {
		firstName: b,
		lastName: f,
		age: a
