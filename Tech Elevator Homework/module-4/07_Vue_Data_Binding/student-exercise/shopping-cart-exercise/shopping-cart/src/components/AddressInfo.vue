        ...
        <form>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" id="shippingCity" v-model="deliveryInfo.city">
            </div>
            <div class="form-group col-md-4">
              <label for="shippingState">State</label>
              <select id="shippingState" class="form-control" v-model="deliveryInfo.state">
            ...
            <div class="form-group col-md-2">
              ...
              <input type="text" class="form-control" id="shippingZip" v-model="deliveryInfo.zip">
            </div>
          </div>
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <div class="form-check">
                <input
                  ...
                  value="Front Door"
                  checked
                  v-model="deliveryInfo.deliverto"
                >
          ...
          <div class="billing-add" v-if="!billingSameAsShipping">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="billingCity" v-model="billingInfo.city">
              </div>
              <div class="form-group col-md-4">
                ...
                <select id="billingState" class="form-control">
                  ...
                  <option value="MI">MI</option>
                  <option value="OH">OH</option>
                  <option value="PA">PA</option>v-model="billingInfo.state"
                </select>
              </div>
              <div class="form-group col-md-2">
                <label for="billingZip">Zip</label>
                <input type="text" class="form-control" id="billingZip" v-model="billingInfo.zip">
              </div>
            </div>
          </div>
