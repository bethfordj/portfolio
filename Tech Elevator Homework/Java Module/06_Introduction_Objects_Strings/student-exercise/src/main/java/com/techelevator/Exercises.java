...
public class Exercises {
	...
	public String middleThree(String str) {
		int substringStart = (int) str.length()/2;
		return str.substring(substringStart - 1,substringStart+2);
	}
	...
	public String frontTimes(String str, int n) {
		if (str.length() - 1 > 3) {
		String frontOfTheString = str.substring(0,3);
		
			for (int i = n; i > 1; i--) {
				frontOfTheString += str.substring(0,3);
			
			}
			System.out.println(frontOfTheString);
			return frontOfTheString;

		}
		
		else if (n > 0) {
			String repeatedText = str;
			for (int i = n; i > 1; i--) {
				repeatedText += str;
	...
	public boolean doubleX(String str) {
		...
		if ((firstIndexOfX < str.length() - 1) && (Character.toString(str.charAt(firstIndexOfX + 1)).equals("x"))) {
			return true;
		}
		return false;
	...
	public String stringBits(String str) {
		...
		for (int i = 0; i <= str.length() - 1; i = i + 2) {
			everyOtherLetter += Character.toString(str.charAt(i));
		}
	...
	public String stringSplosion(String str) {
		...
		for (int i = 0; i + 1 <= str.length(); i++) {
			finalLetterCombination += str.substring(0,i + 1);
		}
	...
	public int last2(String str) {
		...
		for (int i = 0; i < remainingString.length() - 1; i++) {
			if (remainingString.substring(i, i + 2).contains(last2Letters)) {
	...
	public String stringX(String str) {
		...
		for (int i = 1; i <= str.length()-2; i++) {
			...
			if (str.substring(i,i+1).equals("x")) {
				...
				middleOfString += str.substring(i,i+1);
			}
		}
		if (str.length() > 2) {
		return str.substring(0,1) + middleOfString + str.substring(str.length()-1);
		}
		else {
			return str;
		}
	...
	public String altPairs(String str) {
		...
		String altLettersBy45 = "";
		int savedValueOfI = 0;
		
		for (int i = 0; i < str.length() - 1; i += 4) {
			
			altLettersBy45 += Character.toString(str.charAt(i)) + Character.toString(str.charAt(i + 1));
			savedValueOfI = i;
		}
		if ((str.length() - 1 == savedValueOfI + 4) && (str.length() % 2 == 1)) {
		System.out.println(altLettersBy45 + Character.toString(str.charAt(savedValueOfI + 4)));
		return altLettersBy45 + Character.toString(str.charAt(savedValueOfI + 4));
		}
		else if (str.length() > 1){
			return altLettersBy45;
		}
		return str;
	}
	/*
