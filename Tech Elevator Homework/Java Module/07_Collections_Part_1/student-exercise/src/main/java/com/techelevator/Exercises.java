...
public class Exercises {
	...
	public List<String> array2List(String[] stringArray) {
		List<String> arrayMadeList = new ArrayList<String>();
		
		for (String holdingVariable : stringArray)
			arrayMadeList.add(holdingVariable);

		return arrayMadeList;
	}
	...
	public List<String> no4LetterWords(String[] stringArray) {
		...
		List<String> no4LetterWords = new ArrayList<String>();
			...
			for (String placeHolder : stringArray) {
				if (placeHolder.length() != 4)
				no4LetterWords.add(placeHolder);
			}
	...
	public List<String> reverseList(List<String> stringList) {
		...
		Stack<String> reverseProcess = new Stack<String>();
		
		for (String stringLoop : stringList) {
			reverseProcess.push(stringLoop);
			}
		
		
		List<String> reverseList = new ArrayList<String>();		
		
		while (!reverseProcess.isEmpty() ) {
			reverseList.add(reverseProcess.pop());
			}
	...
	public List<Double> arrayInt2ListDouble(int[] intArray) {
		...
		for (int i : intArray) {
			Double placeHolder = (double)(i)/2;
			listOfDoubles.add(placeHolder);
		}
    ...
    ** INTERVIEW QUESTION **	 
	...
	public List<Integer> interleaveLists(List<Integer> listOne, List<Integer> listTwo) {
		...
		List<Integer> interwovenLists = new ArrayList<Integer>();
		
		if (listOne.size() == listTwo.size()) {		
			for (Integer i = 0; i < listTwo.size(); i++) {
				interwovenLists.add(listOne.get(i));
				interwovenLists.add(listTwo.get(i));
			}			
		}
