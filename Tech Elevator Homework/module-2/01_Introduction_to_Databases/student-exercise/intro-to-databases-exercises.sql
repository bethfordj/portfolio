...
select name, continent, headofstate from country where governmentform like '%onarchy%';
...
select (2019 - indepyear) as years_since_indep from country where indepyear is not null;
